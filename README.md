...
<li>But still there always remains a scope wherein we could introduce technology and ease the entire procedure and develop something that could make our lives easier.</li>
<li>Our team figured out such a gap in the heathcare sector wherein we believed that people faced a lot of difficulties in - 
<ul>
<li>Managing and maintaing all the recent medical records.</li>
...
<hr>
<p>Our entire project is divided into 4 parts-</p>
<ol>
<li><strong>Doctor Section</strong>-First of all as a doctor you have to sign up with all your details if you are not a member.If you have already registered then login to the application directly.After login you will see a Doctor dashboard with some basic details.Here you have a section to create a sample prescription by uploading your clinic logo,name,etc. details<br>
A doctor can also be a patient thus we have also added sections of medical records and a section to view their personalized health card.<br>
The doctor section also has a search bar at the top to search for patients they want to access.</li>
<li><strong>Patient Section</strong>-The patient will have to first sign up with all the details.If already registered the patient can directly login to use the application.After logging in the patient can see a patient dashboard with all the sections and muliple sections similar to doctor like medical records and a personalized soft copy of health card.<br>
In the document section we have provided option to download all the medical documents all at once and individually also.<br>
Two additional sections in the patient is the diagnosis section, wherein patients can diagnose a disease with the help of an AI/ML integrated system with symptom based disease prediction.Another section is the online medicine section which alerts the nearest pharmacy an online request to deliver medicines.</li>
<li><strong>Patient-Doctor interaction</strong>-This is sort of a hidden section which can only be viewed once a doctor enters and accesses the patient section.This section is similar to the patient section but has read-only capabilities so that the patient data remains secure and intact.The doctor can view past medical history,get an overview of patient's health condition and in succession write an online prescription to the patient in our online prescription system which will be automatically uploaded to medical records of patient on successful submission.The patient can download and view the prescription from here else he/she will also spontenously get an email with the prescription attached.</li>
<li><strong>Pharmacy Section</strong>-To access the pharmacy section the pharmacy needs to sign up and fill the details to create an account.Once done, the pharmacy can directly login to the system and can track the medicines in their shop, online delivery tracking, can generate a bill online and accept or reject patient's request for medicine.</li>
</ol>
</p>
<br>
<br>
...
<li><strong>Verification of the patient and donor</strong>-Any users who registered on our website are thoroughly checked so that there are no issue like corrupt practices,just for fun activities and so on.We uniquely identify the doctor and patient via the document initials and we have a strict email alert system in place to alert the patient and doctor on each login.</li>
<li><strong>Close proximity and level playing ground</strong>-We connect each and every patient to the closest doctor wherein we take into consideration the frequency of requests to particular doctor and his/her closeness to the patient location.This will help the patient get the closest possible help from the doctor in case of intense medical emergencies and also give each and every doctor an equal opportunity to treat a patient.</li>
...
<hr>
<ol>
<li><strong>Mobile Number based authentication</strong>-Currently we rely on the email based OTP authentication but in future we aim to add in mobile number based authentication.</li>
<li><strong>Improve security</strong>-Security is a feature of topmost priority for any medical system as medical records are a very sensitive user data.</li>
...
<li><strong>We aim to centralize the finances of the pharmacy and doctors so that we could track their income and prevent malpractice.</li>
